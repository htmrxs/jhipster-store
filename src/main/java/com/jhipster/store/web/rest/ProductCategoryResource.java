...
import com.jhipster.store.domain.ProductCategory;
import com.jhipster.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.jhipster.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
