...
import com.jhipster.store.domain.ProductOrder;
import com.jhipster.store.service.ProductOrderService;
...
/**
 * REST controller for managing {@link com.jhipster.store.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
public class ProductOrderResource {
    ...
    public ResponseEntity<ProductOrder> updateProductOrder(@Valid @RequestBody ProductOrder productOrder) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productOrder.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ProductOrder> getProductOrder(@PathVariable String id) {
